/**
 * Headless Step 5d self-test (Optimise wire: BuildUnits → PackWithTwins → layout).
 * Usage: node tools/run-step5d-selftest.mjs
 */
import fs from 'fs';
...
const out = context.csPackV2Step5dSelfTest();
